...
const testimonials = [
  {
    ...
    review:
      "Karan is a visionary developer. His attention to detail and creativity blew us away. Our project was a massive success because of him.",
    image: m1,
  },
  {
    ...
    review:
      "Working with Karan was an absolute pleasure. He brings design and code together like magic. Highly recommend him!",
    image: w1,
  },
  {
    name: "Amy Jacobsan",
    ...
    review:
      "From concept to execution, Karan handled everything flawlessly. His work ethic and innovation are unmatched.",
    image: m2,
  },
  {
    name: "Carry Smith",
    ...
    review:
      "Karan transformed our outdated platform into something modern and powerful. His skills are world-class.",
    image: w2,
  },
];
...
const Testimonials = () => {
  return (
    <section id='testimonials' className='relative min-h-screen bg-[#1d2330] text-white flex flex-col items-center justify-between px-6 py-20'>
      <motion.h2
