  ...
  return (
    <footer className='relative overflow-hidden bg-black'>
      ...
      >
        ...
        <div className='h-1.5 w-24 md:w-32 rounded-full bg-linear-to-r from-[#0d58cc] via-cyan-300 to-emerald-500' />
        ...
        <p className='text-gray-300 italic max-w-xl'>"Success is when preparation meets oppoutunity."</p>
        <p className='text-xs text-gray-400'>&copy; {new Date().getFullYear()} Karan Kerma. All rights reserved.</p>
      </motion.div>
    </footer>
  )
}
